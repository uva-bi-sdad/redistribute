...
We can take the two-step method further by repeating the process to
try and better fit both the household and individual data:
...
error <- do.call(cbind, lapply(structure(pvars, names = pvars), function(var) {
  d <- cbind(
    ...
    pums_nstep = estimate_nstep$block_groups[[var]],
