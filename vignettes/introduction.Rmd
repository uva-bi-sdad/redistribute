...
if (!file.exists(zipcode_file)) {
  download.file(paste0(
    ...
    "IPLS/IPLSMap/MapServer/3/query?",
    'geometry={"xmin":-90,"ymin":-90,"xmax":90,"ymax":90,',
    '"spatialReference":{"wkid":4326}}&outFields=*&f=geojson'
  ), zipcode_file)
}
...
if (!file.exists(parcel_file)) {
  download.file(paste0(
    ...
    "314bfe4019754952a715be3a33384d9d_0/",
